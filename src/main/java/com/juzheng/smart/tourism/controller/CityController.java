...
public class CityController {
    ...
    @ApiOperation(value="根据cookie中的城市id返回天气", notes="需要进一步解析json")
    @RequestMapping(value = "/api/city/weather", method = RequestMethod.GET)
    public String cityweather() {
        ...
        try {
            ...
            return map.get("showapi_res_body").toString();
        } catch (Exception e) {
            e.printStackTrace();
            return "error";
        }
