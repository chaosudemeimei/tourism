...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
       ...
       // gc.setEnableCache(true);
        ...
        dsc.setUrl("jdbc:mysql://101.132.139.188:3306/smart_tourism_platform?useUnicode=true&useSSL=false&characterEncoding=utf8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("9609");
        ...
        //pc.setModuleName("");
        pc.setParent("com.juzheng.smart.tourism");
